...
export class ProductsController {
    ...
    async createProduct(@Req() req, @Body()payload: CreateProductDto, @UploadedFile() file: Express.Multer.File):Promise<Product>{
...
//      const latitude = 27.5291;  // Chitwan lat
      ...
      return await this.productService.getNearestProducts(longitude, latitude);
